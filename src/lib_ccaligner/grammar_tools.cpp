...
void PerformChecks(grammarName name, bool generateQuickLM)
{
	int rv;
...
bool generate(std::string transcriptFileName, grammarName name)
{
	...
	PerformChecks(name, generateQuickLM);
